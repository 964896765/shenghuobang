...
ALTER TABLE `capability_grants` ADD CONSTRAINT `capability_grants_org_membership_fk` FOREIGN KEY (`organizationMembershipId`) REFERENCES `organization_memberships`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `capability_grants` ADD CONSTRAINT `capability_grants_staff_position_fk` FOREIGN KEY (`platformStaffPositionId`) REFERENCES `platform_staff_positions`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `permission_audit_events` ADD CONSTRAINT `perm_audit_events_active_identity_fk` FOREIGN KEY (`activeIdentityId`) REFERENCES `business_identities`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `permission_audit_events` ADD CONSTRAINT `perm_audit_events_staff_position_fk` FOREIGN KEY (`platformStaffPositionId`) REFERENCES `platform_staff_positions`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `workspace_preferences` ADD CONSTRAINT `workspace_preferences_staff_position_fk` FOREIGN KEY (`platformStaffPositionId`) REFERENCES `platform_staff_positions`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `workspace_preferences` ADD CONSTRAINT `workspace_preferences_run_fk` FOREIGN KEY (`migrationRunId`) REFERENCES `migration_runs`(`migrationRunId`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
